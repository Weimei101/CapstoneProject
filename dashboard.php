...
?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-download fa-sm text-white-50"></i> Inventory Records</a>
    </div>
    ...
    <!-- Total Records of Inventory -->
    <div class="col-12 mb-4">
        <a href="tables.php" class="card-link">
    ...
    <div class="col-12 mb-4">
        <a href="record_user.php" class="card-link">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Phinma  ITSD</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <p>ITSD hhadhadhadhadhadhahahahahhahahahhahahahahahahahahahahahahahahahahahah <a>
                                            hihihihihihihiihihihihihihihihihihihihihihih hihihihihiihihihihihihihihihihih
                                            ihihihih
                                        ...
                                        <a> qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqwwwwwwwwwwwwwww
                                            eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeereeeeeeeeeeee 
                                            unDraw &rarr;</a>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Inventory Approach</h6>
                                    </div>
                                    <div class="card-body">
                                        <p>haaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaa
                                            haaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaahaaaaaaaaaaa</p>
                                        <p class="mb-0">ihihihihihhihihihihihhihihihihihhihihihihihhihihihihihhihihihihihh
                                            ihihihihihhihihihihihhihihihihihhihihihihihhihihihihihhihihihihihh</p>
                                    </div>
                                </div>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>ITSD &copy; Your Website 2023</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
